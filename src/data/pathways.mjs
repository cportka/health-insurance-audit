...
const ACA_EXTERNAL_STATE = {
  ...
  what: "An independent doctor/organization reviews the denial. Their decision is binding on the plan.",
    ...
    steps: [
      {
        ...
        decisionWithin: { standard: { amount: 72, unit: "hours" }, expedited: { amount: 24, unit: "hours" } },
  ...
  fehb: {
    ...
    steps: [
      ...
      },
      {
        ...
        fileFrom: "after the plan affirms its denial (or doesn't respond in time)",
        decisionNote: "Write to OPM within the window stated in the plan's final denial; OPM reviews the disputed claim.",
        authority: "5 CFR 890.105",
        sources: [SRC.opm],
      },
    ],
